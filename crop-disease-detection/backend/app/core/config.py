...
class Settings(BaseSettings):
    ...
    # Once your frontend is deployed (e.g. to Vercel), add its real URL here
    # — e.g. "https://your-project.vercel.app" — or the deployed frontend
    # will get CORS errors calling this API.
    CORS_ORIGINS: list[str] = [
        "http://localhost:3000",
        "http://localhost:5173",
        "http://localhost:8080",
        "http://127.0.0.1:5500",
        # "https://your-project.vercel.app",  # <-- uncomment and fill in after deploying
    ]
